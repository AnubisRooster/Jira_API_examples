...
jql_query = 'project in (MCDB, DB, PLAT) AND issuetype in (Bug, Story, Task, Sub-task, Escalation, Investigation, "Customer Support", Test) AND status in (Closed, "Code Ready") AND created > -720d'
