...
jql_query = 'project in ([specify_project]) AND issuetype in (Bug, Story, Task, Sub-task, Improvement, Investigation, "New Feature", Request) AND status = Done AND created > -160d'
